...
public class TimerDemo1 extends JFrame implements KeyListener {
    ...
    private final Timer enemyTimer;        // propels top enemy horizontally across screen
    private final Timer playerTimer;       // propels bottom player horizontally across screen
    ...
    private final static int SCREEN_HEIGHT = 300;   // height of screen
    ...
    public TimerDemo1() {
        ...
        enemyTimer = new Timer(200, (ActionEvent evt) -> {
            if (enemyX <= 10) // left boundary  detection for enemy
            {
                enemyMoveAmount = 10;
            } else if (enemyX > SCREEN_WIDTH-40){ // right boundary detection for enemy
        ...
        playerTimer = new Timer(200, (ActionEvent evt) -> {
            if (playerX <= 10) // left boundary detection for player
            {
                playerMoveAmount = 10;
            } else if (playerX > SCREEN_WIDTH-40){ // right boundary detection for player
