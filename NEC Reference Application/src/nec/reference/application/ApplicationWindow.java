...
public class ApplicationWindow extends javax.swing.JFrame {
    ...
    private void jComboBox2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox2ItemStateChanged
        ...
        switch (index1) {
            case 0: //  Conduit 
                jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "3⁄8","1⁄2","3⁄4","1","1 1⁄4","1 1⁄2","2","2 1⁄2","3","3 1⁄2","4","5","6" }));
                jComboBox3.setSelectedIndex(-1);
                jComboBox3.setVisible(true);
                break;
            case 1: // Ampacity
    ...
    private void jComboBox5ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox5ItemStateChanged
        ...
        int index3 = jComboBox1.getSelectedIndex();
        int index4 = jComboBox1.getSelectedIndex();
        switch (index2) {
                   case 0: //  EMT 
                       switch (index3) {
                           case 0: // 3/8 
